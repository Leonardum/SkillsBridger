...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$err) {
		...
		$message = "$userName (id = $userId) would like to add a new company: $name.<br><br>This user's contact details are:<br>Phone number: $phone<br>E-mail address: $userMail<br><br>The user described the company and its activities as follows:<br>" . $message;
		...
		$mail->addAddress('companyapplications@skillsbridger.com');
...
<h1>The safety and privacy of our users is SkillsBridger's number one priority. Therefore we ask all companies that wish to publish job offers and consult the SkillsBridger database, to fill in the following form.<br>Our team will evaluate this data and contact you as soon as possible.</h1><br>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
	...
	<div class="userInput">
		...
		<label>Name of the company you wish to add to SkillsBridger:</label>
	...
	<div class="userInput">
		...
		<label>The phone number on which we can contact you:</label>
	...
	<div class="userInput" style="padding-top:2rem;">
		...
		<label>Please, describe your company and its activities briefly:</label>
